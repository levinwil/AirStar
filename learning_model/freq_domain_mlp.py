...
class MLP(object):
    ...
    test_size : Double
        the proportion of data you want to set aside for testing if you don't
...
if __name__ == "__main__":
    ...
    epochs =  7 #you probably want to keep this between 0 and 100 if you want it running < 5 minutes
    batch_size = 256
    ...
    if test_x != None and test_labels != None:
